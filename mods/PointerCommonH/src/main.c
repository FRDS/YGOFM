...
struct x y[] =
{
    ...
    TEST16(&gp_static.DuelStats[0].LPDisplay),
    TEST16(&gp_static.DuelStats[0].LPActual),
    TEST16(&gp_static.DuelStats[0].viewCard),
    TEST16(&gp_static.DuelStats[2].LPDisplay),
    TEST16(&gp_static.DuelStats[2].LPActual),
    TEST16(&gp_static.DuelStats[2].viewCard),
